...
namespace MaterialSkin.Controls
{
    public class MaterialSnackBar : MaterialForm
    {
        ...
        private void UpdateRects()
        {
            ...
            {
                int _buttonWidth = ((TextRenderer.MeasureText(ActionButtonText, SkinManager.getFontByType(MaterialFontType.Button))).Width + 32);
            ...
            Width = TextRenderer.MeasureText(_text, SkinManager.getFontByType(MaterialFontType.Body2)).Width + (2 * LEFT_RIGHT_PADDING) + _actionButton.Width + 48;
            Region = System.Drawing.Region.FromHrgn(CreateRoundRectRgn(0, 0, Width, Height, 6, 6));
