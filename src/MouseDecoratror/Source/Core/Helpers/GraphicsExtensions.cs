...
namespace MouseDecoratror.Core
{
    ...
    {
        public static void DrawHighlighter(this Graphics gr, HighlighterSettings circle)
        {
            ...
            int doubleRadius = circle.Radius * 2;
            ...
            else
            {
                ...
                using (Pen pen = new Pen(selectedColor, circle.OutlineThickness))
                {
                    ...
                    gr.DrawEllipse(pen, new Rectangle(5, 5, doubleRadius - 5, doubleRadius - 5));
                }
            }
